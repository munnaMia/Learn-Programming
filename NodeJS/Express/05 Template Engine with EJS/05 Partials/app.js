...
app.get("/post", (req, res) => {
    res.render('pages/post', {title: 'this a title'}) 
});
...
app.get("/about", (req, res) => {
    ...
    res.render('pages/about', {title: 'this a title', post: testOBJ,  testOBJ2}) // we can pass value as object into ejs file to use as a variable
});
...
app.get("/", (req, res) => {
    ...
    res.render('pages/index', {title: 'this a title', post: testOBJ,  testOBJ2}) // we can pass value as object into ejs file to use as a variable
});
